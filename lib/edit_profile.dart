                                 ...
                                 child: ClipRRect(
                                   ...
                                   child: Row(
                                     ...
                                     children: [
                                       Column(
                                         children: [
                                           Image(image: AssetImage("images/document_icon.png"),height: 40,width: 40,),
                                           SizedBox(
                                             height: 10,
                                           ),
                                           Text("Need to upload"),
                                           ...
                                           Row(
                                             children:[
                                               Text("Your institution ID",style: TextStyle(fontSize: 12,color: Colors.black,fontWeight: FontWeight.bold),),
                                               Text("(Optional)",style: TextStyle(fontSize: 10,color: Colors.grey[400]),),
                                             ],
                                           )
                                         ],
                                       )
